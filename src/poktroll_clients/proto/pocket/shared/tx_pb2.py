...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_MSGUPDATEPARAMRESPONSE']._serialized_end=662
  _globals['_MSG']._serialized_start=665
  _globals['_MSG']._serialized_end=850
